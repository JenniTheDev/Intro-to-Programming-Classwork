...
int main(int argc, char** argv) {
    ...
    //How to play should be one function
    ...
    do {
        ...
        }while (play!=2);                //sends back to start with do while loop 
        ...
        //number of tries should be a function 
    ...
    //The number to color business should be its own function
